...
class ExcelPlatzuebersicht(View):

    @method_decorator(login_required)
    @method_decorator(user_passes_test(lambda u: u.is_staff))
    def get(self, request, verwzr_id):
        """
        ...
        with xlsxwriter.Workbook(buf, {'in_memory': True}) as workbook:
            ...
            # Die Blöcke belegen die erste Zeile. Dabei nehmen sie so viele
            # Zellen ein, wie sie Zeiträume besitzen.
            b = 1
            ...
            Eine Praxis hat dabei zwei Zeilen. Der Name der Praxis erstreckt
            sich über zwei Zellen. Falls ein Platz auftaucht, schreiben wir die
            Platzinfos in zwei Zellen. In die obere kommen Name und
            Matrikelnummer und in die untere kommt die E-Mail-Adresse als Link.
            """
            ...
            for praxis in pl_tab:
                ...
                # Die Platzbegrenzung bekommen dazu, jedoch brauchen wir sie
                # nicht. Daher lassen wir das letzte Element weg.
